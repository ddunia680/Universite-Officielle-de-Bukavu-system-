					 ...
					 <?php
						...
						$electric="Faculte de Science en Electricite";
					         ...
					         ?>
					             ...
					             <tr>
					             <td>Faculte</td>
					             <td id="faculte1"><select name="faculte"  style="height: 30px; width: 400px; border-radius: 10px;">
					 ...
					 <?php
						...
						$journ="Faculte de Journalisme";
					         ...
					         ?>
					             ...
					             <tr>
					             <td>Faculte</td>
					             <td id="faculte2"><select name="faculte"  style="height: 30px; width: 400px; border-radius: 10px;">
			    ...
			    <?php
						...
						$eco="Faculte de Science en Economie Generale";
					         ...
					         ?>
					             ...
					             <tr>
					             <td>Faculte</td>
					             <td id="faculte3"><select name="faculte"  style="height: 30px; width: 400px; border-radius: 10px;">
				             ...
				             ?>
				               	<p>Cet etudiant n'a pas de faculte</p>
				             <?php 
				               }
		 }
